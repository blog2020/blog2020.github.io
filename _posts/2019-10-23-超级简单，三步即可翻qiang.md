...
然后解压，接着鼠标双击打开：【ShadowsocksR-dotnet4.0.exe】或者【ShadowsocksR-dotnet2.0.exe】，如果打开弹出窗口报错，那就先安装这个微软的运行库：

<a href="https://www.microsoft.com/zh-cn/download/details.aspx?id=17718" target="_blank">点击下载安装</a>

安装完微软运行库后，就可以打开软件输入配置，注意，XP系统的要用aes-256-cfb 加密方式：
